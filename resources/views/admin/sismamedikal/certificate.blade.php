...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1 style="width:87%">Certificate</h1>
    ...
    <div class="section-body">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item {{ request()->routeIs('/certificate') ? 'active' : '' }}">
      ...
      <p class="section-leadx">Certificate.</p>
      <div class="card">
              ...
              <table class="table table-striped" id="table-z">
                ...
                <tbody>
                 <tr class="text-center">
                    ...
                    <td><button class="btn btn-primary">Export Certificate</button></td>
                 </tr>
                </tbody>
              </table>
            </div>
