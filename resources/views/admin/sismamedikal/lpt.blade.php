...
@section('title', 'List Progress Training')
...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1 style="width:87%">List Progress Training</h1>
    ...
    <div class="section-body">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item {{ request()->routeIs('/LPT') ? 'active' : '' }}">
            @if(request()->routeIs('/LPT'))
            List Progress Training
            @else
            <a href="#">List Progress Training</a>
            @endif
          </li>

        </ol>
      </nav>
      <p class="section-leadx">List Progress Training.</p>
      <div class="card">
