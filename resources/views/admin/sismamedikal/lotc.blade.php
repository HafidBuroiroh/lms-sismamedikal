...
@section('title', 'List Of Training Categories')
...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1 style="width:87%">List Of Training Categories</h1>
    ...
    <div class="section-body">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item {{ request()->routeIs('/LOTC') ? 'active' : '' }}">
            @if(request()->routeIs('/LOTC'))
            List Of Training Categories
            @else
            <a href="#">List Of Training Categories</a>
            @endif
          </li>

        </ol>
      </nav>
      <p class="section-leadx">List kategori pelatihan.</p>
      <div class="card">
